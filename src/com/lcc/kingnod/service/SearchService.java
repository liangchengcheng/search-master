...
import com.lcc.kingnod.dto.NewsDTO;
import com.lcc.kingnod.elasticsearch.EsClientConfig;
import com.lcc.kingnod.entity.News;
...
public class SearchService {
    ...
    public void builderSearchIndex() {
        ...
        try {
            ...
            //Bulk 2个参数 1:索引名称 2:类型名称(用文章article做类型名称)
    ...
    public List<NewsDTO> search(String content, String index, String type) {
        ...
        if (StringUtils.isNotBlank(content)) {
            ...
            SearchResponse response = client.prepareSearch(index)
                    ...
                    .setQuery(qb)
                    .addAggregation(AggregationBuilders.terms("titleAgg").field("title").size(5))
                    .execute().actionGet();
