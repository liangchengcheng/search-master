...
/**
 * 日志切面类    切面必须注解为 @Service @Aspect
 * 或者@Component @Aspect
 * 或者@Aspect
 * 并且在springmvc-servlet.xml中加上<bean class=""/>注入
 */
//@Component
@Service
@Aspect
public class LogAspect {
    ...
    @Before("execution(* com.lcc.kingnod.controller.LoginController.loginPost(..))")
